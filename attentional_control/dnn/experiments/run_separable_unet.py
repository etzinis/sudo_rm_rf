"""!
@brief Run Tensor-mask based source separation
...
import attentional_control.dnn.models.separable_unet as esunet
...
model = esunet.EfficientSeparableUNet(
                 n_sources=hparams['n_sources'],
                 initial_basis=hparams['n_basis'],
                 basis_embedding=hparams['H'],
                 depth=hparams['X'],
                 glu=True,
                 upsample=False,
                 rescale=0.1,
                 initial_kernel=hparams['n_kernel'],
                 computation_factor=1,
                 layer_stride=2,
                 layer_kernel=hparams['P'],
                 growth=2.,
                 context=3)
